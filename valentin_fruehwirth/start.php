...
//Hier ist das Zeitfenster drin
//Hier ist die Premiere, der HTML Code ist ganz unten!!
//Hier wird das mit der Zeitabfrage und der nochmaligen Suche gemacht
...
if(isset($_POST['search']) || isset($_POST['searchfield']))
{
    ...
    //Mit dem oben wird das dann alles ausgegeben, was es zwischen den Zeiträumen gegeben hat --Das gehört noch zum obrigen Teil dazu
    ...
    try
    {
        ...
        $stmt3->execute();
        //Hier wird dann nur alles reingegeben, was ich vorher in der definierten Zeitsuche genommen habe, deswegen $query, da ich in dieser ja vorher die suche gemacht habe
        ...
        //Hier wird dann alles ausgegeben, was wir dann nochmals speziell gesucht haben --Also nach Datumssuche ist das hier dann die explizite Suche
        if(isset($_POST['searchfield']))
        {
            ...
            echo '</div>
                  <div class="row">';
            //Hier wird dann alles ausgegeben, wenn ich meine gesuchte Zeitangabe nocheinmal filtern möchte
...
} else
{
    ...
    //Hier unten drunter ist der normale Zeitraum, den man sich aussuchen kann
?>
